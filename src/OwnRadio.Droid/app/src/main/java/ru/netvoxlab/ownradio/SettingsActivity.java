...
//		Preference freeMemorySize = (Preference) findPreference("free_memory_size");// your preferences key
//		freeMemorySize.setTitle(getString(R.string.pref_free_memory_size) + new TrackToCache(getApplicationContext()).FreeSpace());
	}
...
//		return AboutAppFragment.class.getName().equals(fragmentName);
//	}
}
