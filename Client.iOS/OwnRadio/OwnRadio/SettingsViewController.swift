...
class SettingsViewController: UITableViewController, SKProductsRequestDelegate, SKPaymentTransactionObserver {
	...
	func tapDelAllTracks(sender: UITapGestureRecognizer) {
		...
		dellAllTracksAlert.addAction(UIAlertAction(title: "ОК", style: .default, handler: { (_: UIAlertAction!) in
			let tracksUrlString = FileManager.applicationSupportDir().appending("/Tracks/")
		...
		dellAllTracksAlert.addAction(UIAlertAction(title: "ОТМЕНА", style: .cancel, handler: { (_: UIAlertAction!) in
	...
	@IBAction func delListenTracksBtn(_ sender: UIButton) {
		...
		dellListenTracksAlert.addAction(UIAlertAction(title: "ОК", style: .default, handler: { (_: UIAlertAction!) in
		...
		dellListenTracksAlert.addAction(UIAlertAction(title: "ОТМЕНА", style: .cancel, handler: { (_: UIAlertAction!) in
		}))
